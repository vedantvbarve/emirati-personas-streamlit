...
defaults = {
    ...
    'user_input': "",
    'conversation_events': [],
    'selected_traits': [],  # Start empty - user must choose
...
if not st.session_state.setup_complete:
    ...
    with col2:
        if st.button("✅ Done - Start Chatting!", type="primary", use_container_width=True):
            # If no traits selected, use all traits as default
            if not st.session_state.selected_traits:
                st.session_state.selected_traits = st.session_state.available_traits
...
# ==========================================
    ...
    with col2:
        if st.button("🔄 Reset", key="reset_setup"):
            st.session_state.setup_complete = False
            st.rerun()
